                                ...
                                <form role="form" action="{{URL::to('/save-color-product')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="color_key" placeholder="mã màu">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tên màu </label>
                                        <input type="text" class="form-control" name="color_name" placeholder="tên màu">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputFile">ảnh hình họa màu</label>
                                        <input type="file" id="exampleInputFile" name="images_color">
                                    </div>                            
                                    <button type="submit" class="btn btn-info"	name="add_color_product">Thêm Màu Mới</button>
                                </form>
                            </div>
                        </div>
                    </section>
                                ...
                                <form role="form" action="{{URL::to('/save-size-product')}}" method="post">
                                    @csrf
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="size_key" placeholder="mã màu">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Chiều cao </label>
                                        <input type="text" class="form-control" name="chieu_cao" placeholder="chiều cao">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Cân nặng</label>
                                        <input type="text" class="form-control" name="can_nang" placeholder="Cân nặng" value="">
                                    </div>
                                   
                                    
                                    
                                    <button type="submit" class="btn btn-info"  name="add_size_product">Thêm Size Mới</button>
                                </form>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/save-detail-product')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ct_size" class="form-control input-sm m-bot15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ct_mau" class="form-control input-sm m-bot15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ct_sp" class="form-control input-sm m-bot15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="solg_sp" placeholder="số lượng" value="">
                                    </div>
                                    <button type="submit" class="btn btn-info"  name="add_detail_product">Thêm Chi Tiết Mới</button>
                                </form>
                            </div>
                        </div>
                    </section>
